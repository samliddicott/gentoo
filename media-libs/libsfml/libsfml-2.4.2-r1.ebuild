...
src_prepare() {
	# Do not install bundled deps; only applicable on mingw builds and maybe osx.
	# Upstream PR: https://github.com/SFML/SFML/pull/1237
	epatch "${FILESDIR}"/${PN}-2.4.2-no-install-extlibs-mingw.patch
